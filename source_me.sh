...
# --- Repo-root import path (required) ---------------------------------------
# Scripts live in extract/, cleanup/, and audit/ and import the sibling
# repo-root modules markdown_quality and pdf_extract. Must come after sourcing
# ~/.bashrc, which clears PYTHONPATH.
