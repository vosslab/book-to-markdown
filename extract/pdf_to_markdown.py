#!/usr/bin/env python3
"""Extract a PDF through the qualified Tesseract OCR pipeline into Markdown."""
...
def parse_args() -> argparse.Namespace:
	"""Parse the qualified PDF-to-Markdown OCR command line."""
	parser = argparse.ArgumentParser(
		description="Extract a PDF through Tesseract OCR into page-free Markdown",
	)
	parser.add_argument("pdf", help="Input PDF file")
	parser.add_argument("-o", "--output", dest="output_file", required=True,
		help="Output Markdown path")
	parser.add_argument("-p", "--pages", dest="pages",
		help="Zero-based pages, such as 0,1,24-30")
	...
	parser.add_argument("-j", "--json-report", dest="json_report",
		help="Write comparable JSON evidence")
...
#============================================
def main() -> None:
	"""Convert one PDF through OCR and record extraction evidence."""
	args = parse_args()
