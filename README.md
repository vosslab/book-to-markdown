...
- **Extract** (`extract/`) - `pdf_to_markdown.py` (qualified OCR entry point), `pdf_raw_text_extraction_to_markdown.py`, `pdf_ocr_text_extraction_to_markdown.py`, `pdf_ocr_spread_halves.py`, `epub_structure.py`, `epub_ocr.py`, `semantic_markdown.lua` (Pandoc filter).
